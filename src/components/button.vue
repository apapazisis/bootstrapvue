<template>
    <div>
        ...
        <template v-else-if="type == 'reset'">
            <input class="btn" :class="getClass(variant)" type="reset" value="Reset">
        </template>
        <template v-else-if="type == 'submit'">
            <input class="btn" :class="getClass(variant)" type="submit" value="submit">
        </template>
        <template v-else-if="type == 'input_button'">
            <input class="btn" :class="getClass(variant)" type="button" value="input">
        </template>
    </div>
</template>
